            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image" style="background-image: url(&quot;assets/img/reg.jpg&quot;);"></div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="signup.inc.php" method="post">
                                ...
                                </div><button class="btn btn-primary btn-block text-white btn-user" type="submit" name="signup_submit">Register Account</button>
                                <hr>
                            </form>
